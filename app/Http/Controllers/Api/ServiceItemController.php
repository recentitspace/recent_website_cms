...
class ServiceItemController extends BaseController
{
    ...
    protected $validationRules = [
        'store' => [
            ...
            'domain_extensions' => 'nullable|array',
            'domain_extensions.*.extension' => 'required_with:domain_extensions|string|max:50',
            'domain_extensions.*.price' => 'required_with:domain_extensions|string|max:50',
            'domain_extensions.*.period' => 'nullable|string|max:20',
            'domain_extensions.*.badge' => 'nullable|string|max:100',
